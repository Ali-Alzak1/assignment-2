...
## Tools Used
- **ChatGPT 5 Pro** — used for brainstorming and planning features (the ideas were mine; ChatGPT 5 Pro helped refine the approach).  
- **ChatGPT 5** and **GitHub Copilot** — helped fix small bugs, rewrite unclear code, and explain why certain errors appeared.  
- **Lovable** — handled the complete dark mode styling using my chosen colors and suggested contrast adjustments.
